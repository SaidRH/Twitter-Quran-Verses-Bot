...
def main():
    ...
    fontsize = 30
    font = ImageFont.truetype("Amiri-Regular.ttf", fontsize) 
    fileone = open("Surrah.txt", encoding="utf8") 
    filetwo = open("QuranVerses.txt", encoding="utf8") 
    ...
    font_sura = ImageFont.truetype("Amiri-Bold.ttf", 30)
...
def func():
 fileone = open("TwitterPostTitle.txt", encoding="utf8")
 all_lines_variable_fileone = fileone.readlines()  
